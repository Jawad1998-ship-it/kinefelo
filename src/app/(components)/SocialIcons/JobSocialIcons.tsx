...
const JobSocialIcons = () => {
  return (
    <>
      <Link
        href="#"
        className="flex items-center justify-center bg-white/10 rounded-full hover:bg-white/20 transition-colors"
      >
        <FacebookIcon />
      </Link>
      <Link
